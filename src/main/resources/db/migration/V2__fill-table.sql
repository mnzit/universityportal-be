INSERT INTO tbl_roles(name, created_date)
...
INSERT INTO tbl_master_customers(firstname, middlename, lastname, gender, address, contact_no, email_address, password, role_id,
...
INSERT INTO tbl_book_details(author, title, isbn, published_date, created_date, created_by)
VALUES ('J.K Rowling', 'Harry Potter', '123123123', NOW(), NOW(), 1);

insert into tbl_books(book_detail_id, created_by, created_date)
values (1, 1, NOW()),
       (1, 1, NOW());

INSERT INTO tbl_book_histories(book_id, user_id, book_taken_date, book_returned_date, created_by, created_date)
VALUES (1, 1, NOW(), NOW(), 1, NOW());

INSERT INTO tbl_courses(title, description, duration, duration_type, created_date, created_by)
...
INSERT INTO tbl_subjects(title, description, credit_hours, created_date, created_by)
VALUES ('Java', 'Java is nice', 8, NOW(), 1);

INSERT INTO tbl_programs(year, month, course_id, created_date, created_by)
VALUES (2021, 07, 1, NOW(), 1);

insert into tbl_attendances(program_id, user_id, state, created_date, created_by)
values (1, 1, 'PRESENT', NOW(), 1);

INSERT INTO tbl_course_subjects(course_id, subject_id, created_date, created_by)
VALUES (1, 1, NOW(), 1);

INSERT INTO tbl_authorities(name, created_date)
VALUES ('ADD_USER', NOW()),
       ('VIEW_USER', NOW()),
       ('UPDATE_USER', NOW()),
       ('DELETE_USER', NOW());

INSERT INTO tbl_role_authorities(role_id, authority_id, created_date)
VALUES (1, 1, NOW()),
       (1, 2, NOW()),
       (1, 3, NOW()),
       (1, 4, NOW());
